...
layout: model
title: Tainted Maw
permalink: /factions/rashaar/tainted-maw/
faction: rashaar
...
*Upper ATK2K outlier: among this faction's Specialists the median is 2.6, but this model reaches 20.6, so the role median understates models like this.*
...
| Balanced (Dex4/Prot3) | 2.86 | 1.56 |
| Evasive (Dex6/Prot2) | 2.45 | 1.35 |
| Armoured (Dex4/Prot5) | 1.99 | 1.05 |
| Tank (Dex4/Prot5/US5) | 1.32 | 0.67 |
| Parry (Dex5/Prot3/Parry2) | 1.95 | 0.96 |
...
|---|---|---|---|
| Baseline (Atk3) | 0.87 | 20.6 | 9.7 |
| Elite (Atk5, Dmg+1) | 2.94 | 6.1 | 3.3 |
| Penetrator (Atk3, Pen−3) | 1.89 | 9.5 | 5.0 |
