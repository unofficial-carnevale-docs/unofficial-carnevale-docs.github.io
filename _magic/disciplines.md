...
- **Cantrip of the Devil:** small chip damage or life-drain at short range.
...
- **Cantrip of the Sun:** small heal that also hands out a Will Point.
...
- **Fate's Bounty:** a pool of re-rolls to use on anything.
...
- **Fiery Rhetoric:** hands an ally a Command Point.
- **Waves of Force:** a line of Grapples from water.
- **Walk Between Worlds:** turns a model into a flying, terrain-ignoring ghost.
- **Ice Lock:** Stun plus battlefield-shaping on water.
...
[Spell details and analysis →](/magic/wild-magic/)
